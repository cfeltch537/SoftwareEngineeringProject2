...
public class HealthBarWidget extends Composite{
	...
	public HealthBarWidget(){
		...
		//Set Bar Images
	    hpEmpty = (ImageElement) new Image("hpBars/hpBar_Empty.png").getElement().cast();
	    hpGreen = (ImageElement) new Image("hpBars/hpBar_Green.png").getElement().cast();
	    hpYellow = (ImageElement) new Image("hpBars/hpBar_Yellow.png").getElement().cast();
	    hpOrange = (ImageElement) new Image("hpBars/hpBar_Orange.png").getElement().cast();
	    hpRed = (ImageElement) new Image("hpBars/hpBar_Red.png").getElement().cast();
	    //Add Widget to Panel
