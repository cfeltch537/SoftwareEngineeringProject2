	...
	public Pokedex() {
		...
		try {
			...
			while (stringRead != null) {
				...
				Image spriteFront = new ImageIcon(".\\src\\Battle_Sprites/"
						+ st.nextToken() + ".png").getImage();
				Image spriteBack = new ImageIcon(".\\src\\Battle_Sprites/"
						+ st.nextToken() + ".png").getImage();
				...
				// temp = new
				// PokedexEntry(id,spriteFront,spriteBack,name,details,type,baseHP,baseAtk,baseDef,baseSpAtk,baseSpDef,baseSpd,incHP,incAtk,incDef,incSpAtk,incSpDef,incSpd);
